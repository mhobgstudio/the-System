...
const rawDefaultQuests = [
 { title: "99 Names", difficulty: "Medium", xp: 2, stat: "discipline", category: "learning", comment: "https://drive.google.com/file/d/1OOfWSArPLilmJHmeOtrLgGhfaHmqMTY4/view?usp=sharing", isPinned: true },
  { title: "After all, you asked to be close to the throne", difficulty: "Easy", xp: 1, stat: "willpower", category: "personal" },
  { title: "Agentic Ai", difficulty: "Medium", xp: 2, stat: "discipline", category: "work" },
  { title: "Always Choose the Pleasure of Allah", difficulty: "Hard", xp: 5, stat: "willpower", category: "personal", isPinned: true },
  { title: "Aura Farming With Allah", difficulty: "Medium", xp: 2, stat: "willpower", category: "personal", isPinned: true },
  { title: "Be an Observer", difficulty: "Hard", xp: 5, stat: "willpower", category: "personal", isPinned: true },
  { title: "Selective fast (Jihad of silence): be like salah", difficulty: "Medium", xp: 2, stat: "willpower", category: "personal", comment: "Be on the me app, ask Allah for help for your soul", isPinned: true },
  { title: "Be the Observer", difficulty: "Medium", xp: 2, stat: "willpower", category: "personal" },
  { title: "Complete 5 sets of 25 push-ups", difficulty: "Hard", xp: 3, stat: "strength", category: "personal", comment: "EBOOK/PLAYLIST", isPinned: true },
  { title: "Complete a 30-minute intense agility drill session", difficulty: "Hard", xp: 3, stat: "agility", category: "personal", comment: "EBOOK/PLAYLIST", isPinned: true },
  { title: "CyberExpo_Dev", difficulty: "Medium", xp: 2, stat: "intelligence", category: "work" },
  { title: "Do 100 push-ups throughout the day", difficulty: "Hard", xp: 3, stat: "strength", category: "personal", comment: "EBOOK/PLAYLIST", isPinned: true },
  { title: "Do a 300m run", difficulty: "Hard", xp: 3, stat: "agility", category: "personal", comment: "EBOOK/PLAYLIST", isPinned: true },
  { title: "Don't Disregard Allah in times of sin_softHeart", difficulty: "Medium", xp: 2, stat: "willpower", category: "personal" },
  { title: "Dont get stuck in a 1hr+ loop", difficulty: "Hard", xp: 5, stat: "willpower", category: "personal", comment: "code, short videos", isPinned: true },
  { title: "Dua Daily", difficulty: "Easy", xp: 1, stat: "willpower", category: "personal" },
  { title: "Email", difficulty: "Easy", xp: 1, stat: "discipline", category: "work" },
  { title: "English Tafseer 1pg/Quran", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning" },
  { title: "extras Research", difficulty: "Medium", xp: 2, stat: "intelligence", category: "work", comment: "https://floor796.com/", isPinned: true },
  { title: "Give up something for Allah -Fitna is Refinement", difficulty: "Medium", xp: 2, stat: "willpower", category: "personal" },
  { title: "Grad school", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning", comment: "EBOOK/PLAYLIST", isPinned: true },
  { title: "HealthCheck", difficulty: "Easy", xp: 1, stat: "stamina", category: "health" },
  { title: "Hifz revision", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning" },
  { title: "I WILL NOT LET THE VOICES IN MY HEAD CONTROL ME", difficulty: "Hard", xp: 3, stat: "willpower", category: "personal" },
  { title: "Juz Daily - get 1pg/min of each juz pg", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning", comment: "EBOOK", isPinned: true },
  { title: "Liquid Drop concentration", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning" },
  { title: "LOCK IN: Be to Allah what fang yuan is to u PLTARM", difficulty: "Hard", xp: 3, stat: "willpower", category: "personal" },
  { title: "Madina series", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning" },
  { title: "Maintain a rigorous daily workout routine for a month", difficulty: "Hard", xp: 3, stat: "strength", category: "personal", comment: "GAME: Tele", isPinned: true },
  ...
  { title: "MUJAWWAD .5P", difficulty: "Medium", xp: 2, stat: "discipline", category: "personal" },
  { title: "MultiTask => Brain =< Sleep", difficulty: "Medium", xp: 2, stat: "stamina", category: "health" },
  { title: "n8n tasks", difficulty: "Medium", xp: 2, stat: "discipline", category: "work" },
  { title: "Nahwu", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning" },
  { title: "Nawwafi_Murájá", difficulty: "Medium", xp: 2, stat: "willpower", category: "personal", comment: "1/3 of page per raka; Deep", isPinned: true },
  { title: "people doing what u don't want to do", difficulty: "Medium", xp: 2, stat: "discipline", category: "personal" },
  { title: "Pimsleur Arabic || At least 1 Line || 10mins/1 vid", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning", comment: "https://floor796.com/", isPinned: true },
  { title: "Please ask for help from Allah in each sujuud", difficulty: "Easy", xp: 1, stat: "willpower", category: "personal" },
  { title: "Poetry", difficulty: "Easy", xp: 1, stat: "discipline", category: "personal" },
  { title: "Pray b4 Sleep then Quran Buffs", difficulty: "Easy", xp: 1, stat: "willpower", category: "personal" },
  { title: "Project", difficulty: "Medium", xp: 2, stat: "intelligence", category: "work" },
  { title: "Quantum Code", difficulty: "Hard", xp: 3, stat: "intelligence", category: "learning" },
  { title: "Quiet Dhikr", difficulty: "Easy", xp: 1, stat: "willpower", category: "personal" },
  { title: "Real Maths", difficulty: "Hard", xp: 3, stat: "intelligence", category: "learning" },
  { title: "Resurrection Spell", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning", comment: "the 3 Quls", isPinned: true },
  { title: "Revise students Quran with AudioBook || At least 1 page", difficulty: "Medium", xp: 2, stat: "discipline", category: "learning" },
  { title: "Seerah / Khushu of the Ruh and Nafs", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning" },
  { title: "Sleeping Prayer", difficulty: "Easy", xp: 1, stat: "willpower", category: "personal" },
  { title: "Systematic Review || At least 15 mins", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning" },
  { title: "Take Haram Seriously, it's a big deal in GodSight.", difficulty: "Medium", xp: 2, stat: "willpower", category: "personal" },
  { title: "Teach Quran", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning" },
  { title: "There is more to life than your desires", difficulty: "Medium", xp: 2, stat: "discipline", category: "personal" },
  { title: "Thesis Project NoteBookLM", difficulty: "Hard", xp: 3, stat: "intelligence", category: "work" },
  { title: "think of imam abroad, Allah's is better", difficulty: "Easy", xp: 1, stat: "willpower", category: "personal" },
  { title: "watch teleGratitude", difficulty: "Easy", xp: 1, stat: "discipline", category: "personal" },
  { title: "Word4word Quran", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning" },
  { title: "Workout", difficulty: "Medium", xp: 2, stat: "strength", category: "health" },
  { title: "Yoruba perfection", difficulty: "Medium", xp: 2, stat: "intelligence", category: "learning" },
  { title: "Zad University", difficulty: "Medium", xp: 2, stat: "intelligence", category: "work", comment: "GAME: 2048", isPinned: true }
];
